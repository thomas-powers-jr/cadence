...
- This doc first landed via PR #507 (`97253c11`); a follow-up PR only refreshes these machine facts. Local `main` was synced to `97253c11` and all session worktrees/branches are removed.

## State on handoff   ·  pre-filled — verify, don't retype
- Branch `main` (clean), 0 ahead / 0 behind origin — updated by hand after this doc's first version merged as PR #507
- HEAD `97253c11`
- Recent commits:
```
97253c11 docs(cadence): session handoff for 2026-09-16 (v1.67.1 released, #500/#501 fixed) (#507)
