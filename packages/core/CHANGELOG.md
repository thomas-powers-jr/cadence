...
- 2ef7870: `cadence handoff` now generates a version-2 SESSION doc: the frontmatter reads `cadence_handoff: 2`, and the narrative zone gains a required `## Open decisions` stub between `Carry-forward gotchas` and `Next action`.
